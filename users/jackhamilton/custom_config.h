...
U_NP,              U_NP,              LT(U_MEDIA,KC_ESC),LT(U_NAV,KC_SPC),  KC_CAPS,           LT(U_SYM,KC_ENT),  LT(U_NUM,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP
...
U_NP,              U_NP,              LT(U_NUM,KC_ESC),  KC_SPC,            KC_TAB,            KC_LALT,           LT(U_NAV,KC_BSPC), LT(U_FUN,KC_DEL),  U_NP,              U_NP
